...
urlpatterns = [
    ...
    path('monthly-appointments-and-revenue/', views.MonthlyAppointmentsAndRevenueView.as_view(), name='monthly_appointments_and_revenue'),
    path('daily-appointments-and-revenue/', views.DailyAppointmentsAndRevenueView.as_view(), name='daily_appointments_and_revenue'),
    path('yearly-appointments-and-revenue/', views.YearlyAppointmentsAndRevenueView.as_view(), name='yearly_appointments_and_revenue'),
]
